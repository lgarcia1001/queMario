...
cactus_img = pygame.image.load('cactus_bricks_down.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('cactus_bricks_up.png')
...
class Mario(pygame.sprite.Sprite):
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('mario/mario_1.png')
