...
cactus_img = pygame.image.load('images/cactus_bricks_down.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('images/cactus_bricks_up.png')
...
flames_velocity = 20
mario_up = pygame.image.load('images/mario/mario_1.png')
mario_up_image = pygame.transform.scale(mario_up, (50, 50))
mario_down = pygame.image.load('images/mario/mario_2.png')
...
fundo = scale(load('images/background.jpeg'), BACKGROUND)
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('images/dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('images/fireball.png')
...
class Mario(pygame.sprite.Sprite):
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('images/mario/mario_1.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('media/mario_dies.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('images/end.png')
...
def game_loop():
    ...
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('media/mario_theme.wav')
